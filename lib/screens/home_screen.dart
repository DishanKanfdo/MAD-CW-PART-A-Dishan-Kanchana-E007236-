          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                  hintText: " Search from this Your titles....",
                      ...
                      children: [
                        ...
                        IconButton(
                            onPressed: () async {
                              ...
                              Toast.show("Deleted Successfully from the list", context, duration: Toast.LENGTH_LONG, gravity:  Toast.BOTTOM,backgroundColor:Colors.red);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        return value.isNotEmpty ? null : "needed to fill";
                      },
                      decoration:
                    ...
                    onPressed: () async {
                      if (_formKey.currentState.validate()) {
                        if ('' == editIDController.text) {
                          ...
                          Toast.show("Added Successfully to the list", context, duration: Toast.LENGTH_LONG, gravity:  Toast.BOTTOM,backgroundColor:Colors.green);
                          ...
                          Toast.show("Updated Successfully the list", context, duration: Toast.LENGTH_LONG, gravity:  Toast.BOTTOM,backgroundColor:Colors.blue);
